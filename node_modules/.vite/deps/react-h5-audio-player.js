...
var ProgressBar = class extends import_react2.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "timeOnMouseMove", 0);
    __publicField(this, "hasAddedAudioEventListener", false);
    ...
    __publicField(this, "getCurrentProgress", (event) => {
      const {
        audio,
        progressBar
      } = this.props;
    ...
    __publicField(this, "handleMouseDownOrTouchStartProgressBar", (event) => {
    ...
    __publicField(this, "handleWindowMouseOrTouchMove", (event) => {
      if (event instanceof MouseEvent) {
        event.preventDefault();
      }
      event.stopPropagation();
    ...
    __publicField(this, "handleWindowMouseOrTouchUp", (event) => {
      event.stopPropagation();
    ...
    __publicField(this, "handleAudioTimeUpdate", (() => throttle((e) => {
      const {
        isDraggingProgress
      } = this.state;
    ...
    __publicField(this, "handleAudioDownloadProgressUpdate", (e) => {
      const audio = e.target;
      const duration = this.getDuration();
...
var CurrentTime = class extends import_react3.PureComponent {
  constructor(props) {
    ...
    __publicField(this, "handleAudioCurrentTimeChange", (e) => {
      const audio = e.target;
      const {
        isLeftTime,
        timeFormat,
    ...
    __publicField(this, "addAudioEventListeners", () => {
      const {
        audio
      } = this.props;
      if (audio && !this.hasAddedAudioEventListener) {
...
var Duration = class extends import_react4.PureComponent {
  constructor(props) {
    ...
    __publicField(this, "handleAudioDurationChange", (e) => {
      const audio = e.target;
      const {
        timeFormat,
        defaultDuration
...
var VolumeControls = class extends import_react5.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "hasAddedAudioEventListener", false);
    __publicField(this, "volumeBar", (() => (0, import_react5.createRef)())());
    __publicField(this, "volumeAnimationTimer", 0);
    __publicField(this, "lastVolume", this.props.volume);
    __publicField(this, "state", (() => ({
      currentVolumePos: `${(this.lastVolume / 1 * 100 || 0).toFixed(2)}%`,
      hasVolumeAnimation: false,
      isDraggingVolume: false
    }))());
    __publicField(this, "getCurrentVolume", (event) => {
      const {
        audio
      } = this.props;
    ...
    __publicField(this, "handleClickVolumeButton", () => {
      const {
        audio
      } = this.props;
      if (audio.volume > 0) {
    ...
    __publicField(this, "handleVolumnControlMouseOrTouchDown", (event) => {
      event.stopPropagation();
      const {
        audio
      } = this.props;
    ...
    __publicField(this, "handleAudioVolumeChange", (e) => {
      const {
        isDraggingVolume
      } = this.state;
      const {
...
// node_modules/react-h5-audio-player/es/index.js
var _H5AudioPlayer = class _H5AudioPlayer extends import_react6.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "audio", (() => (0, import_react6.createRef)())());
    __publicField(this, "progressBar", (() => (0, import_react6.createRef)())());
    __publicField(this, "container", (() => (0, import_react6.createRef)())());
    __publicField(this, "lastVolume", (() => this.props.volume ?? 1)());
    __publicField(this, "togglePlay", (e) => {
      e.stopPropagation();
    ...
    __publicField(this, "playAudioPromise", () => {
    ...
    __publicField(this, "handlePlay", (e) => {
      this.forceUpdate();
    ...
    __publicField(this, "handleEnded", (e) => {
      if (!this.audio) return;
      this.forceUpdate();
      this.props.onEnded && this.props.onEnded(e);
    });
    __publicField(this, "handleAbort", (e) => {
    ...
    __publicField(this, "handleMuteChange", () => {
      this.forceUpdate();
    });
    __publicField(this, "handleClickLoopButton", () => {
      this.audio.current.loop = !this.audio.current.loop;
      this.forceUpdate();
    });
    __publicField(this, "handleClickRewind", () => {
      const {
        progressJumpSteps,
        progressJumpStep
      } = this.props;
    ...
    __publicField(this, "handleClickForward", () => {
      const {
        progressJumpSteps,
        progressJumpStep
      } = this.props;
    ...
    __publicField(this, "setJumpTime", (time) => {
      const audio = this.audio.current;
      const {
        duration,
    ...
    __publicField(this, "setJumpVolume", (volume) => {
    ...
    __publicField(this, "renderUIModules", (modules) => {
      return modules.map((comp, i) => this.renderUIModule(comp, i));
    });
    __publicField(this, "renderUIModule", (comp, key) => {
      const {
        defaultCurrentTime = "--:--",
        ...
        loop: loopProp = false,
        mse,
        i18nAriaLabels = _H5AudioPlayer.defaultI18nAriaLabels
      } = this.props;
      switch (comp) {
...
__publicField(_H5AudioPlayer, "defaultI18nAriaLabels", {
  player: "Audio player",
...
var H5AudioPlayer = _H5AudioPlayer;
